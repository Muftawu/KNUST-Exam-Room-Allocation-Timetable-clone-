...
SECRET_KEY = 'django-insecure-0!22q4p@46^slbgp2mv(*q1tym#itl8pk#5v_ka^hb2u^wdzmh'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, 'invigilator/templates'),
            os.path.join(BASE_DIR, 'base/templates'),
            os.path.join(BASE_DIR, 'room_allocation/templates'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
